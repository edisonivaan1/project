        ...
        <div className={`relative max-w-md mx-auto bg-white rounded-2xl shadow-2xl border-4 ${style.border} overflow-hidden`}>
          ...
          <div className={`p-6 ${style.bgColor}`}>
            <div className="text-center">
              ...
              {/* Category Badge */}
              <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white bg-opacity-80 text-gray-700 mb-4">
            ...
            <div className="text-center">
              <button
                onClick={handleClose}
                className={`px-6 py-2 bg-gradient-to-r ${style.gradient} text-white font-medium rounded-full hover:shadow-lg transition-all duration-200 transform hover:scale-105`}
              >
                Continue Learning
              </button>
            </div>
